<%-- 
    ...
    Created on : 20 Jan, 2022, 10:40:54 PM
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card" style="width: 50rem;">
                                <center><h1>Your subscriptions</h1>_____________________</center>
                                <div class="card-body"><br>
                                    <%
                                        String code = request.getParameter("cid");
                                        Statement st1 = cn.createStatement();
                                        ResultSet rs1 = st1.executeQuery("select * from subscribe where ucode='" + user_code + "'");
                                        while (rs1.next()) {
                                            int status = rs1.getInt("status");
                                            if (status == 0) {
                                                String ch_code = rs1.getString("ch_code");
                                                Statement st2 = cn.createStatement();
                                                ResultSet rs2 = st2.executeQuery("select * from channel1 where code='" + ch_code + "'");
                                                while (rs2.next()) {
                                                    int status1 = rs2.getInt("status");
                                                    if (status1 == 0) {
                                    %>
                                    <table class="table table-borderless">
                                        <tr>
                                            <td align="left">
                                                <div class="form-group">
                                                    <span class="prfil-img"><img src="channel_images/<%=rs2.getString("code")%>.jpg" class = "img-circle" style="width:50px;height:50px" alt=""> </span> 
                                                </div>
                                            </td>
                                            <td align="left">
                                                <div class="form-group">
                                                    <label class="mb-2"><% out.println(rs2.getString("cname"));%></label><br>
                                                     <small class="mb-2">Subscribed on :   <% out.println(rs1.getString("date"));%></small><br>
                                                </div>
                                            </td>
                                            <td><a href="channel_view_sub.jsp" class="btn btn-success">View channel</a></td>
                                            <td><a class="btn btn-default">Unsubscribe</a></td>
                                        </tr>
                                    </table>
                                    <br>
                                    <%
