                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card" style="width: 50rem;">
                                <center><h1>My Channel list</h1>_____________________</center>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <div class="form-group">
                                                        ...
                                                        <small id="emailHelp" class="form-text text-muted"><% out.println(rs1.getString("about"));%></small>
                                                    </div>
                                                </td>
                                                <!--td align="left">
                                                    <a href="video_upload.jsp?cid=<%=rs1.getString("code")%>"><i class="fa fa-video-camera" aria-hidden="true"></i>&nbsp;Upload video</a>
                                                </td>
                                                 <!--td>
                                                     <a href="edit_channel.jsp?cid=<%=rs1.getString("code")%>"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;Edit Channel</a>
                                                </td-->
                                                <td align="right">
                                                    <a href="channel.jsp?cid=<%=rs1.getString("code")%>" class="btn btn-primary">View channel</a>
                                                </td>
                                            </tr>
                                        </table>
                                        <br>
